...
function setup() {
 ...
 console.log(message)
  ...
  invisibleGround = createSprite(200,500,1000,10);
...
function spawnClouds() {
  ...
  if (frameCount % 50 === 0) {
    ...
    cloud.y = Math.round(random(180,350));
    cloud.addImage(cloudImage);
    cloud.scale = 0.5;
    cloud.velocityX = -(7+3*score/1000);
